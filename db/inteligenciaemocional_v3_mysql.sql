...
INSERT INTO iem_escala (id_escala,nombre,descripcion,id_seccion,indicador1,indicador2,indicador3,indicador4)values(2,'Presiones del trabajo','Piense en el mes pasado. En la lista siguiente indique cuánta aficción le produjo cada uan de las presiones del trabajo que se anotan',1,'Mucha','Moderada','Poca','Nada / No Ocurrió') ;
INSERT INTO iem_escala (id_escala,nombre,descripcion,id_seccion,indicador1,indicador2,indicador3,indicador4)values(3,'Presiones personales','Piense en el mes pasado. En la lista siguiente indique cuánta aficción le produjo cada uan de las presiones personales que se anotan',1,'Mucha','Moderada','Poca','Nada / No Ocurrió') ;
...
INSERT INTO iem_escala (id_escala,nombre,descripcion,id_seccion,indicador1,indicador2,indicador3,indicador4)values(17,'Integridad','piense en el mes pasado. El la lista siguiente indique cómo describe cada renglón su conducta o intensión',4,'Mucho','Moderado','Un Poco','Nada bien') ;
